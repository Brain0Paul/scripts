...
tput setaf 7; read -p "Entrez l'ip (ou le nom de domaine) du serveur Zabbix principal: " ZABBIX_HOST_IP
...
for file in ~/scripts/debian/zabbix/zabbix-proxy/docker-compose.yml
do
...
echo ""
tput setaf 7; echo "-----------------------------------------------------------------"
tput bold; tput setaf 7; echo "         => INSTALLATION DE ZABBIX PROXY TERMINEE <="
tput setaf 7; echo ""
